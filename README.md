...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/hamedhdd/x-ui/master/install.sh)
```
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/hamedhdd/x-ui/master/install.sh) 1.8.0
```
...
wget https://github.com/hamedhdd/x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
**Step 2:** Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/hamedhdd/x-ui.git
   cd x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/hamedhdd/x-ui.svg)](https://starchart.cc/hamedhdd/x-ui)
